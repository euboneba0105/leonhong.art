...
async function getArtworksBySeries(seriesId: string): Promise<Artwork[]> {
  const cols = 'id, title, title_en, year, size, status, description, description_en, series_id, created_at, image_url, no_image_index, artwork_tags(tags(id, name, name_en))'
