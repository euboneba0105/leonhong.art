    ...
    <div className={styles.pageContainer}>
      <main className={styles.mainContent}>
            ...
            <div className={styles.seriesChips}>
              {allTags.map((t) => (
                <span key={t.id} className={styles.seriesChip}>
                  ...
                  <button className={styles.seriesChipEdit} onClick={() => setEditingTag(t)}>✎</button>
        ...
        {error ? (
          ...
          <ArtworkGrid artworks={filteredArtworks} isAdmin={isAdmin} onEdit={setEditingArtwork} onDelete={handleDelete} />
        )}
